...
summary_2010 <- list()
summary_2010$Year <- 2010
# Filter data for 1990 and 2010
inca_nation <- inca_nation %>% filter(year == 1990 | year == 2010)
inca_wa <- inca_wa %>% filter(county_name == "King County" & ( year == 1990 | year == 2010))
...
nation_2010 <- inca_nation_summary %>% filter(year==2010) %>% arrange(desc(total_jail_pop_rate)) 
nation_2010_aapi <- inca_nation_summary %>% filter(year==2010) %>% arrange(desc(aapi_jail_pop_rate))
summary_2010$nation_total = inca_nation_total %>% filter(year == 2010) %>% pull(total_jail_pop_rate)
...
summary_2010$king_total = inca_wa %>% filter(year == 2010) %>% pull(total_jail_pop_rate)
summary_2010$nation_aapi = inca_nation_total %>% filter(year == 2010) %>% pull(aapi_jail_pop_rate)
summary_2010$wa_aapi = wa_2010 %>% pull(aapi_jail_pop_rate)
summary_2010$wa_rank_appi = which(grepl("WA", nation_2010_aapi$state))
summary_2010$king_aapi = inca_wa %>% filter(year == 2010) %>% pull(aapi_jail_pop_rate)
...
write.csv(summary, "summaries.csv")